...
"Foundation, seja a versão 3 da Licença, ou\n"
...
msgstr "Incapaz de encontrar o Xephyr, instale-o ou desative a opção Xephyr."
...
msgstr "Atualizar cache de shader"
...
msgstr "Executar um instalador executável do Windows (.exe)"
...
msgstr "Importar um ROM conhecido pelo Lutris"
...
msgstr ""
"Lutris buscará em Lutris.net por jogos que correspondam aos termos que você inserir e "
"quaisquer jogos que encontrar aparecerão aqui.\n"
"\n"
"Quando você clicar em um jogo que foi encontrado, a janela do instalador aparecerá para "
"realizar a instalação."

#: lutris/gui/addgameswindow.py:234
msgid "<b>Search Lutris.net</b>"
msgstr "<b>Buscar Lutris.net"
...
msgstr ""
"Lutris buscará nesta pasta por subpastas que contenham jogos que ele reconheça.\n"
"\n"
"Quaisquer jogos que ele encontrar e que ainda não estejam no Lutris serão adicionados.\n"
"\n"
"Ao clicar em 'Continuar' abaixo, a busca começará e quaisquer jogos encontrados "
"serão adicionados imediatamente."
...
msgstr ""
"Digite o nome do jogo que deseja instalar.\n"
"\n"
"Ao clicar em 'Instalar' abaixo, a janela do instalador aparecerá e o guiará através de uma instalação simples.\n"
"\n"
"O instalador solicitará um executável de configuração e usará o Wine para instalá-lo.\n"
"\n"
"Se você conhece o identificador Lutris do jogo, pode fornecê-lo para uma integração aprimorada com o Lutris, como banners fornecidos pelo Lutris."
...
msgstr "Você deve fornecer um nome para o jogo que está instalando."
...
msgstr "Você deve selecionar um arquivo de script para instalar."

#: lutris/gui/addgameswindow.py:536 lutris/gui/addgameswindow.py:578
#, python-format
msgid "No file exists at '%s'."
msgstr "Nenhum arquivo encontrado em '%s'."
...
"begin."
msgstr ""
"Lutris identificará um ROM por meio de sua hash MD5 e baixará informações do jogo do Lutris.net.\n\nOs dados de ROM usados para isso vêm do projeto TOSEC.\n\nQuando você clicar em 'Instalar' abaixo, o processo de instalação do jogo começará."

#: lutris/gui/addgameswindow.py:576
msgid "You must select a ROM file to install."
msgstr "Você deve selecionar um arquivo ROM para instalar."
...
msgstr "A opção de lançamento padrão será usada para este jogo"

#: lutris/gui/config/common.py:185
#, python-format
msgid "The '%s' launch option will be used for this game"
msgstr "A opção de lançamento '%s' será usada para este jogo"
...
msgstr "Definir arte de capa personalizada"
...
msgstr "Habilitar a presença rica do Discord para jogos disponíveis"
...
msgstr "Nenhum runner correspondeu à pesquisa"
...
msgstr "Procurando checksum no Lutris.net..."
...
msgstr "A plataforma '%s' é desconhecida para o Lutris."
...
msgstr "Autenticação de cookie Humble Bundle"
...
"configuration."
msgstr ""
"<b>Autenticação Humble Bundle via importação de cookie</b>\n"
"\n"
"<b>No Firefox</b>\n"
"- Instale a seguinte extensão: <a href='https://addons.mozilla.org/pt-BR/"
"firefox/addon/export-cookies-txt/'>https://addons.mozilla.org/pt-BR/firefox/"
"addon/export-cookies-txt/</a>\n"
"- Abra uma aba no humblebundle.com e certifique-se de que está logado.\n"
"- Clique no ícone de cookie no canto superior direito, próximo ao menu de "
"configurações\n"
"- Marque 'Prefixar cookies HttpOnly' e clique em 'humblebundle.com'\n"
"- Abra o arquivo gerado e cole o conteúdo abaixo. Clique em OK para "
"finalizar.\n"
"- Você pode apagar o arquivo de cookies gerado pelo Firefox\n"
"- Opcionalmente, <a href='https://support.humblebundle.com/hc/pt-br/"
"requests/new'>abra um ticket de suporte</a> para solicitar que a Humble "
"Bundle corrija sua configuração."
...
msgstr "Alterar o local onde o Lutris baixa arquivos de instalação de jogos."
...
msgstr "install_or_extract só funciona com Wine!"

#: lutris/installer/installer.py:161
#, python-format
msgid "You are not authenticated to %s"
msgstr "Você não está autenticado em %s"
...
msgstr "Motor do RPG Maker 2000 (v1.00 - v1.10)"

#: lutris/runners/easyrpg.py:43
msgid "RPG Maker 2000 engine (v1.50 - v1.51)"
msgstr "Motor do RPG Maker 2000 (v1.50 - v1.51)"

#: lutris/runners/easyrpg.py:44
msgid "RPG Maker 2000 (versão em inglês) engine"
msgstr "Motor do RPG Maker 2000 (versão em inglês)"

#: lutris/runners/easyrpg.py:45
msgid "RPG Maker 2003 engine (v1.00 - v1.04)"
msgstr "Motor do RPG Maker 2003 (v1.00 - v1.04)"

#: lutris/runners/easyrpg.py:46
msgid "RPG Maker 2003 engine (v1.05 - v1.09a)"
msgstr "Motor do RPG Maker 2003 (v1.05 - v1.09a)"

#: lutris/runners/easyrpg.py:47
msgid "RPG Maker 2003 (versão em inglês) engine"
msgstr "Motor do RPG Maker 2003 (versão em inglês)"
...
msgstr "Executa aplicativos Flatpak"
...
msgstr "O identificador exclusivo de três partes do aplicativo (tld.domain.app)"
...
msgstr ""
"A arquitetura para executar. Consulte 'flatpak --supported-arches' para "
"arquiteturas suportadas pelo sistema."
...
msgstr "O branch a ser utilizado."
...
msgstr "Pode ser do tipo sistema ou usuário."
...
msgstr "Argumentos a serem passados para a aplicação."
...
msgstr ""
"O comando a ser executado em vez do que está listado nos metadados do "
"aplicativo."
...
"inside the sandbox."
msgstr ""
"O diretório para executar o comando. Note que este deve ser um diretório "
"dentro do sandbox."
...
msgstr ""
"Define uma variável de ambiente na aplicação. Isso substitui a seção de Contexto "
...
msgstr ""
"A instalação do Flatpak não é tratada pelo Lutris.\n"
"Instale o Flatpak com o pacote fornecido pela sua distribuição."
...
msgstr "Emulador de computadores Atari ST"
...
msgstr ""
"O runner não conseguiu encontrar um comando ou executável para usar nesta configuração."
...
msgid "Punch Tape 1"
msgstr "Fita perfurada 1"

#: lutris/runners/mame.py:117
msgid "Punch Tape 2"
msgstr "Fita perfurada 2"
...
msgstr "Comando de inicialização automática"
...
msgstr "Emulador multi-sistema: NES, PC Engine, PSX…"
...
msgstr "Emulador de computador MSX"
...
msgstr "PAL-N (Argentina, Paraguai, Uruguai)"
...
msgstr "O runner não conseguiu encontrar um comando para aplicar a configuração"
...
msgstr "Define o ritmo da música (em porcentagem, de 50 a 200) para jogos SCUMM (padrão: 100)"

#: lutris/runners/scummvm.py:222
msgid "Digital iMuse tempo"
msgstr "Tempo do iMuse digital"

#: lutris/runners/scummvm.py:223
msgid "Sets internal Digital iMuse tempo (10 - 100) per second (default: 10)"
msgstr "Define o tempo interno do iMuse digital (10 a 100) por segundo (padrão: 10)"
...
msgstr "Especifica o dispositivo que o ScummVM usa para a saída de áudio."
...
msgstr "Seleciona a taxa de amostragem de saída em Hz."
...
msgstr ""
"Escolhe qual emulador é usado pelo ScummVM quando o emulador AdLib é escolhido"
"como dispositivo preferido.
...
msgstr "Define o volume da música, de 0 a 255 (padrão: 192)"
...
msgstr "Define o volume de efeitos sonoros, 0-255 (padrão: 192)"
...
msgstr "Define o volume da fala, 0-255 (padrão: 192)"
...
msgstr "Define o ganho para a reprodução MIDI. 0-1000 (padrão: 100)"
...
msgstr "Especifica o caminho para um arquivo soundfont."

#: lutris/runners/scummvm.py:314
msgid "Mixed AdLib/MIDI mode"
msgstr "Modo AdLib/MIDI misto"

#: lutris/runners/scummvm.py:317
msgid "Combines MIDI music with AdLib sound effects."
msgstr "Combina música MIDI com efeitos sonoros AdLib."
...
msgstr ""
"Indica ao ScummVM que o dispositivo MIDI é um Roland MT-32 real, LAPC-I, "
"CM-64, CM-32L, CM-500 ou outro dispositivo MT-32."
...
msgstr ""
"Informa ao ScummVM que o dispositivo MIDI é um dispositivo GS que possui um mapa MT-32, "
"como um SC-55, SC-88 ou SC-8820."

#: lutris/runners/scummvm.py:341
msgid "Use alternate intro"
msgstr "Usar introdução alternativa"

#: lutris/runners/scummvm.py:342
msgid "Uses alternative intro for CD versions"
msgstr "Usa uma introdução alternativa para as versões em CD"
...
msgstr "Inicia o modo demonstração de Maniac Mansion ou The 7th Guest"
...
msgstr "Define o nível de verbosidade de depuração"

#: lutris/runners/scummvm.py:369
msgid "Debug flags"
msgstr "Sinalizadores de depuração"

#: lutris/runners/scummvm.py:370
msgid "Enables engine specific debug flags"
msgstr "Ativa sinalizadores de depuração específicos do motor"
...
msgstr ""
"Instalação do Steam para Linux não é gerenciada pelo Lutris.\n"
"Por favor, acesse <a href='http://steampowered.com'>http://steampowered.com</a> "
"ou instale o Steam com o pacote fornecido pela sua distribuição."

#: lutris/runners/steam.py:257
msgid "Could not find Steam path, is Steam installed?"
msgstr "Não foi possível encontrar o caminho do Steam, o Steam está instalado?"
...
msgstr "A arquitetura do ambiente do Windows"
...
msgstr "Imagem de DVD no formato ISO"
...
msgstr "Motor de jogo ZDoom DOOM"
...
msgstr "Não há dados de usuário da Amazon disponíveis, faça login novamente"

#: lutris/services/amazon.py:245
msgid "Unable to register device, please log in again"
msgstr "Não foi possível registrar o dispositivo, faça login novamente"

#: lutris/services/amazon.py:260
msgid "Invalid token info found, please log in again"
msgstr "Informações de token inválidas encontradas, faça login novamente"

#: lutris/services/amazon.py:294
msgid "Unable to refresh token, please log in again"
msgstr "Não foi possível atualizar o token, faça login novamente"
...
msgstr ""
"Não foi possível obter as informações do manifesto do jogo, verifique suas credenciais da Amazon e a conectividade da internet"
...
"internet connectivity"
msgstr ""
"Não foi possível obter o manifesto do jogo, verifique suas credenciais da Amazon e a conectividade da internet"
...
msgstr ""
"Algoritmo de compressão desconhecido encontrado no manifesto, verifique suas credenciais da Amazon e a conectividade da internet"
...
"internet connectivity"
msgstr ""
"Não foi possível obter os patches do jogo, verifique suas credenciais da Amazon e a conectividade da internet"
...
"internet connectivity"
msgstr ""
"Não foi possível obter o arquivo fuel.json, verifique suas credenciais da Amazon e a conectividade da internet"

#: lutris/services/amazon.py:572
msgid "Invalid JSON response from Amazon APIs"
msgstr "Resposta JSON inválida das APIs da Amazon"
...
msgstr ""
"Este serviço requer um lançador de jogos. Os seguintes passos o instalarão.\n"
"Assim que o cliente estiver instalado, você poderá fazer login em %s."
...
msgstr "Solução alternativa para autenticação do Humble Bundle"

#: lutris/services/humblebundle.py:86
msgid ""
"Humble Bundle está restringindo as chamadas à API de softwares como o Lutris "
"e o GameHub.\n"
"A autenticação no serviço provavelmente falhará.\n"
"Há uma solução alternativa envolvendo a cópia de cookies do Firefox. "
"Deseja fazer isso em vez disso?"
msgstr ""
"O Humble Bundle está restringindo as chamadas à API de softwares como o Lutris "
"e o GameHub.\n"
"A autenticação no serviço provavelmente falhará.\n"
"Há uma solução alternativa envolvendo a cópia de cookies do Firefox. "
"Deseja fazer isso em vez disso?"
...
msgstr "Não foi possível determinar o URL de download para o jogo."

#: lutris/services/humblebundle.py:249
msgid "No game found on Humble Bundle"
msgstr "Nenhum jogo encontrado no Humble Bundle"
...
msgstr "O Lutris não tem instaladores para %s. Tente usar um serviço diferente."
...
"Lutris"
msgstr ""
"Falha ao abrir o arquivo de banco de dados em %s. Tente renomear este arquivo "
"e reiniciar o Lutris"
...
msgstr "Não especificado (Usar padrão do sistema)"
...
"legacy software."
msgstr ""
"Pode ser usado para forçar uma localização específica para um aplicativo." "Corrige problemas de codificação em software antigo."
